...
Template.accordion.randomPantheonCountry = -> getRandomFromArray(countriesOverTenPeople)
Template.accordion.randomPantheonDomain = -> getRandomFromArray(_.keys(mpdomains))
