...
Deps.autorun ->
  ...
  if (Session.equals("vizMode", "map") and Session.equals("category", "all")) or Session.equals("vizMode", "domain_exports_to_city") or Session.equals("vizMode", "country_by_city")
